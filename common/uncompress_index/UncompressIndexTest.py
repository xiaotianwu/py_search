...
class UncompressIndexTest(unittest.TestCase):
    ...
    def testUncompressIndex(self):
        ...
        s.Add(1, set())
        s.Add(2, set())
        self.assertEqual(s.Fetch(1), set()) 
    ...
    def testUncompressIndexHandler2(self):
        ...
        h2.Add(s2.Fetch(2))
        p2 = h2.Intersect()
        self.assertEqual(p2, set([(2, 0.9), (3, 0.8), (4, 0.7)])) 
        p2 = h2.Union()
        self.assertEqual(p2, set([(1, 1.0), (2, 0.9), (3, 0.8), (4, 0.7), (5, 0.6)])) 
        h2.Clear()
        ...
        h2.Add(s2.Fetch(3))
        p3 = h2.Intersect()
        self.assertEqual(p3, set([(3, 0.8), (4, 0.7)])) 
        p3 = h2.Union()
        self.assertEqual(p3, set([(1, 1.0), (2, 0.9), (3, 0.8), 
                                  (4, 0.7), (5, 0.6), (6, 0.5)]))
    ...
    def testReadWriteWithTinySize(self):
        ...
        self.assertEqual(reader.Read(1), set([(1, 1.0), (2, 0.9), (3, 0.8), (4, 0.7)])) 
        self.assertEqual(reader.Read(2), set([(2, 0.9), (3, 0.8), (4, 0.7), (5, 0.6)])) 
        self.assertEqual(reader.Read(3), set([(3, 0.8), (4, 0.7), (5, 0.6), (6, 0.5)])) 
        reader.Close()
        os.remove(testIndex)
    ...
    def testReadWriteWithLargeSize(self):
        ...
        self.assertEqual(s3.GetIndexMap(), s3Clone.GetIndexMap()) 
        reader.Close()
        reader.Open(testIndex)
        for i in range(0, 1000):
            self.assertEqual(reader.Read(i), s3.Fetch(i)) 
        reader.Close()
